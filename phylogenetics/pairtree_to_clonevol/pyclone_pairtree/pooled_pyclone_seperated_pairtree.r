...
meta$sample_rt_code<-paste(meta$unique_sample_id,meta$sequenceofsamplevRT, sep = "-")
...
file_trees<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/jsons", pattern = "*.tree.json", full.names = TRUE)
...
for (ii in 1:length(file_trees)){
     ...
     subjecta<-gsub("_.*$","",subject_id)  ## SRC125
     ...
     for(kk in 1:length(json_focal$phi)){
      ...
      write.table(out_res_cell, file = paste("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/outputs/trees/tree.",subject_id,".tsv", sep = ""), col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
...
### load pyc.json files 
file_pyc<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/pyc.jsons", pattern = "*pyc.out.json", full.names = TRUE)
...
############################################################
############################################################
filenames_py <- list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/ssms",pattern="*.ssm", full.names = TRUE)  ### load pyclone cluster files
...
write.table(out_res_all_phi, file = "~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/outputs/out_res_paired_seperated_pairtree_phi.txt", col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
...
variants_aa<-merge(variants,meta, by.x = "sample_id", by.y ="sampleid" )[,c("Chromosome" , "Start" , "End" ,"Ref" ,"Alt" ,"Coding" ,"Gene" ,"sample_id" ,"sample_rt_code","sample_id.y")]
names(variants_aa)[9]<-"subject_id"
...
write.table(out_res_var, file = "~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/outputs/out_res_var_paired_seperated_pairtree_pyclone_format_with_cluster0.txt", col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
...
file_trees<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/outputs/trees", pattern = "*.tsv", full.names = TRUE)
file_vars<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/outputs/variants", pattern = "*.tsv", full.names = TRUE)
...
for (ii in 1:length(file_trees)){
      ...
      tree_title<-gsub("/Users/shsoudi/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/outputs/trees/", "",gsub(".tsv","",file_trees[ii]))


      pdf(file = paste("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/trees_final_March08/batch3_pre_post_from_paired_pyclone/outputs/clonevol_trees/clonevol_tree_",tree_title,".pdf", sep = ""), width = 7, height = 7)
