...
## batch3 (fdataclust) (pooled pyclone, seperated pairtree)
...
file_trees<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/jsons", pattern = "*.tree.json", full.names = TRUE)
...
for (ii in 1:length(file_trees)){
     ...
     for(kk in 1:length(json_focal$phi)){
      ...
      write.table(out_res_cell, file = paste("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/trees/tree.",subject_id,".tsv", sep = ""), col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
...
### load pyc.json files 
file_pyc<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/pyc.jsons", pattern = "*pyc.out.json", full.names = TRUE)
...
############################################################
############################################################
filenames_py <- list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/ssms",pattern="*.ssm", full.names = TRUE)  ### load pyclone cluster files
...
write.table(out_res_all_phi, file = "~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/out_res_paired_seperated_pairtree_phi.txt", col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
...
write.table(out_res_var, file = "~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/out_res_var_paired_seperated_pairtree_pyclone_format_with_cluster0.txt", col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
...
for (zz in 1:length(subject_id)){
   ...
   variant_focal_good<-variant_focal[!duplicated(variant_focal$gene),]   ### added
    ...
    #write.table(file = "out_res_phy", file = paste("~/Desktop/out_res_variants_clonevol_format_",subject_id[zz],".txt"), col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
     ...
     write.table(out_res_phy, file = paste("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/variants/variants.",subject_id[zz],".tsv", sep = ""), col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
...
file_trees<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/trees", pattern = "*.tsv", full.names = TRUE)
file_vars<-list.files("~/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/variants", pattern = "*.tsv", full.names = TRUE)
...
for (ii in 1:length(file_trees)){
      ...
      tree_title<-gsub("/Users/shsoudi/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/trees/", "",gsub(".tsv","",file_trees[ii]))


      pdf(file = paste("/Users/shsoudi/Dropbox/cancer_reserach/sarcoma/sarcoma_analysis/pairtree_to_clonevol/April_updated1/fdataclust/outputs/clonevol_trees/clonevol_tree_",tree_title,".pdf", sep = ""), width = 7, height = 7)
